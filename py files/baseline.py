...
#new_model.add(Dense(252, activation='softmax', name='predictions'))
...
new_model.add(Dense(units = 252, activation = 'softmax',
...
train_generator = data_generator.flow_from_directory(
        r'/mnt/c/Users/pietr/Desktop/ImageNet/DATA/train252',
        target_size=(image_size, image_size),  # try to add 3rd dimension (color)
        batch_size=24,
        class_mode='categorical')

validation_generator = data_generator.flow_from_directory(
        r'/mnt/c/Users/pietr/Desktop/ImageNet/DATA/val252',
        target_size=(image_size, image_size),
        class_mode='categorical')

accuracy_generator = data_generator.flow_from_directory(
        r'/mnt/c/Users/pietr/Desktop/ImageNet/DATA/testing/val252',
        target_size=(image_size, image_size),
        class_mode='categorical')

darker_generator = data_generator.flow_from_directory(
        r'/mnt/c/Users/pietr/Desktop/ImageNet/DATA/testing/val_dark',
        target_size=(image_size, image_size),
        class_mode='categorical')

brighter_generator = data_generator.flow_from_directory(
        r'/mnt/c/Users/pietr/Desktop/ImageNet/DATA/testing/val_bright',
        target_size=(image_size, image_size),
        class_mode='categorical')

cropped_generator = data_generator.flow_from_directory(
        r'/mnt/c/Users/pietr/Desktop/ImageNet/DATA/testing/val_crop',
        target_size=(image_size, image_size),
        class_mode='categorical')

noisy_generator = data_generator.flow_from_directory(
        r'/mnt/c/Users/pietr/Desktop/ImageNet/DATA/testing/val_noisy',
        target_size=(image_size, image_size),
        class_mode='categorical')
...
model_history.to_csv(r'/mnt/c/Users/pietr/Thesis/baseline_history.csv')
